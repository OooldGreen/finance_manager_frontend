const ConfirmDeleteModal = ({setShowConfirmDelete, message, onConfirm}) => {
  return (
    <div>
      <div className="flex items-center hs-overlay size-full fixed top-0 start-0 z-999 overflow-x-hidden overflow-y-auto bg-neutral-900/50">
        <div className="mt-0 ease-out transition-all md:max-w-md md:w-full m-3 md:mx-auto">
          ...
          <div className="flex justify-end items-center gap-x-2 py-2 px-4 bg-gray-50 border-t border-gray-200 dark:bg-neutral-950 dark:border-neutral-800">
            <button type="button" onClick={() => {setShowConfirmDelete(false)}} className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800">
              Cancel
            </button>
